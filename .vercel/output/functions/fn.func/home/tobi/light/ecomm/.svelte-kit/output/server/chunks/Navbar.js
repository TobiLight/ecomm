...
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<footer class="mt-auto rounded-lg bg-white p-4 shadow-lg dark:bg-gray-800 sm:flex sm:items-center sm:justify-between sm:p-4"><p class="mb-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:mb-0">© ${escape(currentYear)} <a href="/" class="hover:underline" target="_blank">${escape(PUBLIC_APP_NAME)}</a>.
