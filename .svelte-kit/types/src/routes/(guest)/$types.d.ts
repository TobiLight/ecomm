...
type LayoutRouteId = RouteId | "/(guest)" | "/(guest)/cart" | "/(guest)/checkout" | "/(guest)/payment" | "/(guest)/product" | "/(guest)/product/[id]"
...
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/(guest)/+page.server.js').load>>>>>>;
