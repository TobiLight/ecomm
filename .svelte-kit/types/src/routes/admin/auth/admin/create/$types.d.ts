...
type RouteParams = {  };
type RouteId = '/admin/auth/admin/create';
...
type ActionsExport = typeof import('../../../../../../../../src/routes/admin/auth/admin/create/+page.server.js').actions
export type SubmitFunction = Kit.SubmitFunction<Expand<ActionsSuccess<ActionsExport>>, Expand<ActionsFailure<ActionsExport>>>
export type ActionData = Expand<Kit.AwaitedActions<ActionsExport>> | null;
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../../src/routes/admin/auth/admin/create/+page.server.js').load>>>>>>;
