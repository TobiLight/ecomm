...
type LayoutRouteId = RouteId | "/admin/super/register"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/admin/super/+layout.server.js').load>>>>>>;
