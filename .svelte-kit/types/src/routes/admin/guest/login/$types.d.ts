...
type RouteParams = {  };
type RouteId = '/admin/guest/login';
...
type ActionsExport = typeof import('../../../../../../../src/routes/admin/guest/login/+page.server.js').actions
export type SubmitFunction = Kit.SubmitFunction<Expand<ActionsSuccess<ActionsExport>>, Expand<ActionsFailure<ActionsExport>>>
export type ActionData = Expand<Kit.AwaitedActions<ActionsExport>> | null;
export type PageServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../../src/routes/admin/guest/login/+page.server.js').load>>>>>>;
