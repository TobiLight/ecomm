...
type LayoutRouteId = RouteId | "/admin/guest/login" | "/admin/guest/register"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../../src/routes/admin/guest/+layout.server.js').load>>>>>>;
