...
declare module '$env/static/private' {
	...
	export const npm_package_devDependencies_sveltekit_flash_message: string;
	...
	export const npm_package_dependencies_cardinal: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		_CE_CONDA: string;
		NX_TASK_HASH: string;
		npm_package_devDependencies_sveltekit_flash_message: string;
		...
		npm_package_dependencies_cardinal: string;
